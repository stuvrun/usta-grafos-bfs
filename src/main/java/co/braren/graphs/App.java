...
import co.braren.graphs.algorithm.DepthFirstSearch;
    ...
    public static void main(String[] args) {
        ...
        switch (args[0]) {
            case "-bfs":
                ...
                break;
            case "-dfs":
                text = "El resultado del análisis de los nodos con DFS fue:\n\t" + App.initDFS() + "\n";
                break;
        }
